...
`)();
  var render$4 = function() {
    ...
    return _c("k-markdown-input", {
      ref: "input",
      staticClass: "k-block-type-markdown-input",
      attrs: {
        "blank": _vm.blank,
        "buttons": _vm.buttons,
        "custom-highlights": _vm.customHighlights,
        "disabled": _vm.disabled,
        "font": _vm.font,
        "highlights": _vm.highlights,
        "kirbytext": _vm.kirbytext,
        "known-kirbytags": _vm.knownKirbytags,
  ...
  var MarkdownBlock_vue_vue_type_style_index_0_lang = /* @__PURE__ */ (() => "\n.k-block-container-type-markdown {\n  padding: 0;\n}\n.k-block-type-markdown-input {\n  background: none;\n  border-radius: 0;\n  padding: 0;\n}\n")();
  ...
  var render$3 = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("k-field", _vm._b({
      staticClass: "k-markdown-field",
      attrs: {
        "input": _vm.uid,
        "counter": _vm.counterOptions
      }
    }, "k-field", _vm.$props, false), [_c("k-input", _vm._g(_vm._b({
      ref: "input",
      attrs: {
        "id": _vm._uid,
        "type": "markdown",
    ...
    }, "k-input", _vm.$props, false), _vm.$listeners))], 1);
  };
  ...
  var render$2 = function() {
    ...
    var _c = _vm._self._c || _h;
    return _c("nav", {
      staticClass: "k-toolbar k-markdown-toolbar"
    }, [_c("div", {
      staticClass: "k-toolbar-buttons k-markdown-toolbar-buttons"
    }, [_vm._l(_vm.layout, function(_ref, buttonIndex) {
      var button = _ref.button, name2 = _ref.name, isActive = _ref.isActive, isDisabled = _ref.isDisabled;
      return [button.divider ? [_c("hr", {
        ...
        return _c("k-dropdown-item", {
          key: dropdownItemIndex,
          attrs: {
            "icon": dropdownItem.icon,
            "current": _vm.active.includes(dropdownItem.token)
          },
          on: {
          ...
          domProps: {
            "innerHTML": _vm._s(dropdownItem.label)
          }
        })]);
      }), 1)], 1)] : [_c("k-button", {
        key: buttonIndex,
        class: (isDisabled() ? "is-disabled " : "") + (isActive() || name2 === "invisibles" && _vm.invisibles ? "is-active " : "") + "k-toolbar-button k-markdown-button" + (button.align === "right" ? " k-markdown-toolbar-button-right" : ""),
        attrs: {
          "icon": button.icon,
          "tooltip": button.label,
          "tabindex": "-1"
  ...
  function applyDOMChange(view, start, end, typeOver) {
    ...
    else if ((browser$1.mac || browser$1.android) && change && change.from == change.to && change.from == sel.head - 1 && change.insert.toString() == ".")
  ...
  class EditorView {
    ...
    get hasFocus() {
      var _a2;
      return (document.hasFocus() || browser$1.safari && ((_a2 = this.inputState) === null || _a2 === void 0 ? void 0 : _a2.lastContextMenu) > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
    }
    focus() {
  ...
  class MatchDecorator {
    constructor(config) {
      let { regexp, decoration, boundary, maxLength = 1e3 } = config;
      if (!regexp.global)
  ...
  var render = function() {
    ...
    var _c = _vm._self._c || _h;
    return _c("div", {
      staticClass: "k-markdown-input-wrap",
      attrs: {
        "data-theme": _vm.theme,
        "data-font-family": _vm.font,
        "data-font-size": _vm.fontSize,
        "data-layout": _vm.layout,
        "data-dragover": !!_vm.isDragOver,
        "data-size": _vm.size,
        "data-invisibles": _vm.invisibles
      }
    }, [_vm.buttons && !_vm.disabled && !_vm.hideToolbar ? _c("k-markdown-toolbar", {
      ref: "toolbar",
      attrs: {
        "buttons": _vm.toolbarButtons,
        "active": _vm.active,
        "invisibles": _vm.invisibles
      },
      nativeOn: {
      ...
      return _c(extension.dialog, _vm._b({
        key: extension.name,
        ...
        on: {
          ...
          "submit": function($event) {
            var _vm2;
            return (_vm2 = _vm).submitDialog.apply(_vm2, [extension].concat(Array.prototype.slice.call(arguments)));
          }
        }
      }, "component", _vm.$props, false));
    }), _vm.uploads ? _c("k-upload", {
      ref: "fileUpload",
      on: {
        "success": _vm.insertUpload
      }
    }) : _vm._e()], 2);
  };
  var staticRenderFns = [];
  render._withStripped = true;
  var MarkdownInput_vue_vue_type_style_index_0_lang = /* @__PURE__ */ (() => `

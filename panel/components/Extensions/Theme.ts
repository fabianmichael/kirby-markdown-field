import { EditorView, Rect, ViewPlugin } from '@codemirror/view';
...
function theme(): CodeMirrorExtension {
...
function scrollMargin() {
  return ViewPlugin.fromClass(
    ...
    {
      provide: (plugin) =>
        EditorView.scrollMargins.of((view): Partial<Rect> | null => {
          const value = view.plugin(plugin);
          return value as Partial<Rect> | null;
        }),
    },
  );
}

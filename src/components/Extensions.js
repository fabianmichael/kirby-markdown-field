...
export default class Extensions {
  ...
  getFromHighlights() {
    console.log("ee3", this.extensions)
    return this.getByType("highlight");
  }

  getFromKirbytags() {
    console.log("ee3", this.extensions)
    return this.getByType("kirbytags");
  }
  ...
  //     return (excludedExtensions instanceof Array) ? this.extensions
  ...
  //       .map(extension => extension[feature]({
  //         ...params,
  //         utils
  //       }));
  //   }
  ...
  //     const fromExtensions    = this.getFromExtensions("inputRules", { schema }, allowedExtensions);
  //     const fromNodesAndMarks = this.getFromNodesAndMarks("inputRules", { schema }, allowedExtensions);
  ...
  //     const allowedExtensions = this.getAllowedExtensions(excludedExtensions);
  //     const fromExtensions    = this.getFromExtensions("pasteRules", { schema }, allowedExtensions);
  //     const fromNodesAndMarks = this.getFromNodesAndMarks("pasteRules", { schema }, allowedExtensions);
